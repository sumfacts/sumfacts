        ...
        return (
          ...
          >
            <Space size="large" direction="vertical">
              ...
              <div style={{ display: 'flex', justifyContent: 'center', padding: mobile ? '20px 0' : '100px 0' }}>
              ...
              <Image
                ...
                style={{ paddingBottom: mobile ? 0 : 100 }}
              />

              <Row>
                <Col md={8} style={{ padding: mobile ? '20px 0' : 50 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', padding: mobile ? '30px 40px' : '100px 0' }}>
